...
function buildInjectedFilter(
  ...
  return `${sentinel}{/*marker-read-per-provider-rewrite................................................................................................................................................................................................................................................................................................................................................................................................................................................................*/try{const __cbSessionId=${helpers.sessionIdFunc}();if(__cbSessionId){const __cbFs=${helpers.fsFunc}();const __cbConfigDir=${helpers.configDirFunc}();const __cbMarkerPath=String(__cbConfigDir).replace(/\\/+$/,'')+"/archived-"+__cbSessionId+".json";let __cbIds=[];try{const __cbRaw=__cbFs.readFileSync(__cbMarkerPath);const __cbText=Buffer.isBuffer(__cbRaw)?__cbRaw.toString("utf8"):String(__cbRaw);const __cbParsed=JSON.parse(__cbText);if(Array.isArray(__cbParsed))__cbIds=__cbParsed.filter((__cbId)=>typeof __cbId==="string")}catch{__cbIds=[]}const __cbArchivedIds=new Set(__cbIds);if(__cbArchivedIds.size>0)${messagesVar}=${messagesVar}.filter((__cbMessage)=>!(__cbMessage&&typeof __cbMessage.uuid==="string"&&__cbArchivedIds.has(__cbMessage.uuid)))}}catch{}}`;
}
